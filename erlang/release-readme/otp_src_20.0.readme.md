...
- [Erlang/OTP 20.0 Release README](#erlangotp-200-release-readme)
- [HIGHLIGHTS](#highlights)
    - [-](#-)
    - [OTP-13820    Application(s): ssl](#otp-13820----applications-ssl)
    - [OTP-13900    Application(s): crypto](#otp-13900----applications-crypto)
    - [OTP-13921    Application(s): crypto, ssl](#otp-13921----applications-crypto-ssl)
    - [OTP-14059    Application(s): kernel, stdlib](#otp-14059----applications-kernel-stdlib)
    - [OTP-14094    Application(s): stdlib](#otp-14094----applications-stdlib)
    - [OTP-14110    Application(s): ssh](#otp-14110----applications-ssh)
    - [OTP-14152    Application(s): erts](#otp-14152----applications-erts)
    - [OTP-14178    Application(s): compiler, erts](#otp-14178----applications-compiler-erts)
    - [OTP-14183    Application(s): stdlib](#otp-14183----applications-stdlib)
    - [OTP-14193    Application(s): ssh](#otp-14193----applications-ssh)
    - [OTP-14197    Application(s): ssl](#otp-14197----applications-ssl)
    - [OTP-14205    Application(s): erts](#otp-14205----applications-erts)
    - [OTP-14219    Application(s): asn1](#otp-14219----applications-asn1)
    - [OTP-14226    Application(s): stdlib](#otp-14226----applications-stdlib)
    - [OTP-14291    Application(s): ssl](#otp-14291----applications-ssl)
    - [OTP-14319    Application(s): stdlib](#otp-14319----applications-stdlib)
    - [OTP-14331    Application(s): erts, stdlib](#otp-14331----applications-erts-stdlib)
    - [OTP-14356    Application(s): erts](#otp-14356----applications-erts)
    - [OTP-14388    Application(s): ssl](#otp-14388----applications-ssl)
    - [OTP-14407    Application(s): erts, otp](#otp-14407----applications-erts-otp)
- [*TODO: after here not processed*](#todo-after-here-not-processed)
- [POTENTIAL INCOMPATIBILITIES](#potential-incompatibilities)
    - [-](#-)
    - [OTP-12872    Application(s): ssh](#otp-12872----applications-ssh)
    - [OTP-13006    Application(s): kernel](#otp-13006----applications-kernel)
    - [OTP-13820    Application(s): ssl](#otp-13820----applications-ssl)
    - [OTP-13827    Application(s): erts](#otp-13827----applications-erts)
    - [OTP-13844    Application(s): erts](#otp-13844----applications-erts)
    - [OTP-13873    Application(s): crypto](#otp-13873----applications-crypto)
    - [OTP-13908    Application(s): erts](#otp-13908----applications-erts)
    - [OTP-14039    Application(s): mnesia](#otp-14039----applications-mnesia)
    - [OTP-14094    Application(s): stdlib](#otp-14094----applications-stdlib)
    - [OTP-14110    Application(s): ssh](#otp-14110----applications-ssh)
    - [OTP-14146    Application(s): asn1](#otp-14146----applications-asn1)
    - [OTP-14152    Application(s): erts](#otp-14152----applications-erts)
    - [OTP-14171    Application(s): crypto](#otp-14171----applications-crypto)
    - [OTP-14263    Application(s): ssh](#otp-14263----applications-ssh)
    - [OTP-14264    Application(s): ssh](#otp-14264----applications-ssh)
    - [OTP-14272    Application(s): erts, otp](#otp-14272----applications-erts-otp)
    - [OTP-14331    Application(s): erts, stdlib](#otp-14331----applications-erts-stdlib)
    - [OTP-14343    Application(s): diameter](#otp-14343----applications-diameter)
    - [OTP-14531    Application(s): stdlib](#otp-14531----applications-stdlib)
- [asn1-5.0](#asn1-50)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14316    Application(s): asn1, crypto, runtime_tools](#otp-14316----applications-asn1-crypto-runtimetools)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-13961    Application(s): asn1](#otp-13961----applications-asn1)
        - [OTP-14146    Application(s): asn1](#otp-14146----applications-asn1)
        - [OTP-14219    Application(s): asn1](#otp-14219----applications-asn1)
- [common_test-1.15](#commontest-115)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14332    Application(s): common_test](#otp-14332----applications-commontest)
        - [OTP-14400    Application(s): common_test, snmp, stdlib](#otp-14400----applications-commontest-snmp-stdlib)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-13806    Application(s): common_test](#otp-13806----applications-commontest)
        - [OTP-14179    Application(s): common_test](#otp-14179----applications-commontest)
        - [OTP-14284    Application(s): common_test](#otp-14284----applications-commontest)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
        - [OTP-14415    Application(s): common_test](#otp-14415----applications-commontest)
- [compiler-7.1](#compiler-71)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-13690    Application(s): compiler, stdlib](#otp-13690----applications-compiler-stdlib)
        - [OTP-14408    Application(s): compiler](#otp-14408----applications-compiler)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-12148    Application(s): compiler, erts](#otp-12148----applications-compiler-erts)
        - [OTP-13794    Application(s): compiler](#otp-13794----applications-compiler)
        - [OTP-13831    Application(s): compiler, erts, hipe, kernel, percept,](#otp-13831----applications-compiler-erts-hipe-kernel-percept)
        - [OTP-13856    Application(s): compiler](#otp-13856----applications-compiler)
        - [OTP-13924    Application(s): compiler](#otp-13924----applications-compiler)
        - [OTP-14000    Application(s): compiler, erts, stdlib](#otp-14000----applications-compiler-erts-stdlib)
        - [OTP-14042    Application(s): compiler](#otp-14042----applications-compiler)
        - [OTP-14058    Application(s): compiler](#otp-14058----applications-compiler)
        - [OTP-14071    Application(s): compiler, stdlib](#otp-14071----applications-compiler-stdlib)
        - [OTP-14072    Application(s): compiler](#otp-14072----applications-compiler)
        - [OTP-14087    Application(s): compiler](#otp-14087----applications-compiler)
        - [OTP-14125    Application(s): compiler, dialyzer](#otp-14125----applications-compiler-dialyzer)
        - [OTP-14178    Application(s): compiler, erts](#otp-14178----applications-compiler-erts)
        - [OTP-14221    Application(s): compiler](#otp-14221----applications-compiler)
        - [OTP-14369    Application(s): compiler, dialyzer, stdlib](#otp-14369----applications-compiler-dialyzer-stdlib)
        - [OTP-14401    Application(s): compiler](#otp-14401----applications-compiler)
- [cosProperty-1.2.2](#cosproperty-122)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14006    Application(s): cosProperty, orber](#otp-14006----applications-cosproperty-orber)
- [crypto-4.0](#crypto-40)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14247    Application(s): crypto](#otp-14247----applications-crypto)
        - [OTP-14316    Application(s): asn1, crypto, runtime_tools](#otp-14316----applications-asn1-crypto-runtimetools)
        - [OTP-14435    Application(s): crypto](#otp-14435----applications-crypto)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-13779    Application(s): crypto](#otp-13779----applications-crypto)
        - [OTP-13873    Application(s): crypto](#otp-13873----applications-crypto)
        - [OTP-13900    Application(s): crypto](#otp-13900----applications-crypto)
        - [OTP-13921    Application(s): crypto, ssl](#otp-13921----applications-crypto-ssl)
        - [OTP-14092    Application(s): crypto](#otp-14092----applications-crypto)
        - [OTP-14140    Application(s): crypto](#otp-14140----applications-crypto)
        - [OTP-14171    Application(s): crypto](#otp-14171----applications-crypto)
        - [OTP-14274    Application(s): crypto](#otp-14274----applications-crypto)
        - [OTP-14317    Application(s): crypto, stdlib](#otp-14317----applications-crypto-stdlib)
        - [OTP-14436    Application(s): crypto](#otp-14436----applications-crypto)
- [debugger-4.2.2](#debugger-422)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14296    Application(s): debugger, stdlib](#otp-14296----applications-debugger-stdlib)
        - [OTP-14318    Application(s): debugger](#otp-14318----applications-debugger)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
- [dialyzer-3.2](#dialyzer-32)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14423    Application(s): dialyzer](#otp-14423----applications-dialyzer)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14125    Application(s): compiler, dialyzer](#otp-14125----applications-compiler-dialyzer)
        - [OTP-14127    Application(s): dialyzer](#otp-14127----applications-dialyzer)
        - [OTP-14218    Application(s): dialyzer](#otp-14218----applications-dialyzer)
        - [OTP-14336    Application(s): dialyzer, otp](#otp-14336----applications-dialyzer-otp)
        - [OTP-14369    Application(s): compiler, dialyzer, stdlib](#otp-14369----applications-compiler-dialyzer-stdlib)
- [diameter-2.0](#diameter-20)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14338    Application(s): diameter](#otp-14338----applications-diameter)
        - [OTP-14343    Application(s): diameter](#otp-14343----applications-diameter)
        - [OTP-14455    Application(s): diameter](#otp-14455----applications-diameter)
- [edoc-0.9](#edoc-09)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14277    Application(s): edoc](#otp-14277----applications-edoc)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
- [erl_docgen-0.7](#erldocgen-07)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14333    Application(s): erl_docgen](#otp-14333----applications-erldocgen)
        - [OTP-14431    Application(s): erl_docgen](#otp-14431----applications-erldocgen)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14371    Application(s): erl_docgen](#otp-14371----applications-erldocgen)
- [erl_interface-3.10](#erlinterface-310)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14310    Application(s): erl_interface, kernel](#otp-14310----applications-erlinterface-kernel)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14337    Application(s): erl_interface, erts, jinterface](#otp-14337----applications-erlinterface-erts-jinterface)
- [erts-9.0](#erts-90)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-13968    Application(s): erts](#otp-13968----applications-erts)
        - [OTP-14238    Application(s): erts, hipe](#otp-14238----applications-erts-hipe)
        - [OTP-14255    Application(s): erts](#otp-14255----applications-erts)
        - [OTP-14303    Application(s): erts](#otp-14303----applications-erts)
        - [OTP-14304    Application(s): erts](#otp-14304----applications-erts)
        - [OTP-14305    Application(s): erts](#otp-14305----applications-erts)
        - [OTP-14307    Application(s): erts](#otp-14307----applications-erts)
        - [OTP-14314    Application(s): erts](#otp-14314----applications-erts)
        - [OTP-14324    Application(s): erts](#otp-14324----applications-erts)
        - [OTP-14335    Application(s): erts](#otp-14335----applications-erts)
        - [OTP-14352    Application(s): erts](#otp-14352----applications-erts)
        - [OTP-14360    Application(s): erts](#otp-14360----applications-erts)
        - [OTP-14390    Application(s): erts, kernel](#otp-14390----applications-erts-kernel)
        - [OTP-14411    Application(s): erts](#otp-14411----applications-erts)
        - [OTP-14424    Application(s): erts](#otp-14424----applications-erts)
        - [OTP-14433    Application(s): erts](#otp-14433----applications-erts)
        - [OTP-14437    Application(s): erts](#otp-14437----applications-erts)
        - [OTP-14441    Application(s): erts](#otp-14441----applications-erts)
        - [OTP-14447    Application(s): erts](#otp-14447----applications-erts)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-11695    Application(s): erts](#otp-11695----applications-erts)
        - [OTP-12148    Application(s): compiler, erts](#otp-12148----applications-compiler-erts)
        - [OTP-13529    Application(s): erts](#otp-13529----applications-erts)
        - [OTP-13684    Application(s): erts](#otp-13684----applications-erts)
        - [OTP-13692    Application(s): erts, stdlib](#otp-13692----applications-erts-stdlib)
        - [OTP-13827    Application(s): erts](#otp-13827----applications-erts)
        - [OTP-13831    Application(s): compiler, erts, hipe, kernel, percept,](#otp-13831----applications-compiler-erts-hipe-kernel-percept)
        - [OTP-13842    Application(s): erts](#otp-13842----applications-erts)
        - [OTP-13844    Application(s): erts](#otp-13844----applications-erts)
        - [OTP-13860    Application(s): erts](#otp-13860----applications-erts)
        - [OTP-13903    Application(s): erts](#otp-13903----applications-erts)
        - [OTP-13908    Application(s): erts](#otp-13908----applications-erts)
        - [OTP-13976    Application(s): erts](#otp-13976----applications-erts)
        - [OTP-14000    Application(s): compiler, erts, stdlib](#otp-14000----applications-compiler-erts-stdlib)
        - [OTP-14002    Application(s): erts](#otp-14002----applications-erts)
        - [OTP-14069    Application(s): erts](#otp-14069----applications-erts)
        - [OTP-14149    Application(s): erts](#otp-14149----applications-erts)
        - [OTP-14152    Application(s): erts](#otp-14152----applications-erts)
        - [OTP-14178    Application(s): compiler, erts](#otp-14178----applications-compiler-erts)
        - [OTP-14186    Application(s): erts, kernel](#otp-14186----applications-erts-kernel)
        - [OTP-14201    Application(s): erts](#otp-14201----applications-erts)
        - [OTP-14205    Application(s): erts](#otp-14205----applications-erts)
        - [OTP-14272    Application(s): erts, otp](#otp-14272----applications-erts-otp)
        - [OTP-14330    Application(s): erts, hipe](#otp-14330----applications-erts-hipe)
        - [OTP-14331    Application(s): erts, stdlib](#otp-14331----applications-erts-stdlib)
        - [OTP-14337    Application(s): erl_interface, erts, jinterface](#otp-14337----applications-erlinterface-erts-jinterface)
        - [OTP-14347    Application(s): erts, stdlib](#otp-14347----applications-erts-stdlib)
        - [OTP-14348    Application(s): erts](#otp-14348----applications-erts)
        - [OTP-14356    Application(s): erts](#otp-14356----applications-erts)
        - [OTP-14357    Application(s): erts, kernel, runtime_tools](#otp-14357----applications-erts-kernel-runtimetools)
        - [OTP-14380    Application(s): erts](#otp-14380----applications-erts)
        - [OTP-14381    Application(s): erts](#otp-14381----applications-erts)
        - [OTP-14384    Application(s): erts](#otp-14384----applications-erts)
        - [OTP-14385    Application(s): erts](#otp-14385----applications-erts)
        - [OTP-14407    Application(s): erts, otp](#otp-14407----applications-erts-otp)
        - [OTP-14425    Application(s): erts, kernel](#otp-14425----applications-erts-kernel)
        - [OTP-14434    Application(s): erts](#otp-14434----applications-erts)
        - [OTP-14438    Application(s): erts](#otp-14438----applications-erts)
        - [OTP-14442    Application(s): erts](#otp-14442----applications-erts)
        - [OTP-14453    Application(s): erts](#otp-14453----applications-erts)
- [eunit-2.3.3](#eunit-233)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14287    Application(s): eunit](#otp-14287----applications-eunit)
- [hipe-3.16](#hipe-316)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-13862    Application(s): hipe](#otp-13862----applications-hipe)
        - [OTP-13983    Application(s): hipe](#otp-13983----applications-hipe)
        - [OTP-14238    Application(s): erts, hipe](#otp-14238----applications-erts-hipe)
        - [OTP-14302    Application(s): hipe](#otp-14302----applications-hipe)
        - [OTP-14306    Application(s): hipe](#otp-14306----applications-hipe)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-13810    Application(s): hipe](#otp-13810----applications-hipe)
        - [OTP-13831    Application(s): compiler, erts, hipe, kernel, percept,](#otp-13831----applications-compiler-erts-hipe-kernel-percept)
        - [OTP-13879    Application(s): hipe](#otp-13879----applications-hipe)
        - [OTP-14261    Application(s): hipe](#otp-14261----applications-hipe)
        - [OTP-14293    Application(s): hipe](#otp-14293----applications-hipe)
        - [OTP-14330    Application(s): erts, hipe](#otp-14330----applications-erts-hipe)
- [inets-6.4](#inets-64)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14394    Application(s): inets](#otp-14394----applications-inets)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14404    Application(s): inets](#otp-14404----applications-inets)
        - [OTP-14429    Application(s): inets](#otp-14429----applications-inets)
- [jinterface-1.8](#jinterface-18)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14337    Application(s): erl_interface, erts, jinterface](#otp-14337----applications-erlinterface-erts-jinterface)
- [kernel-5.3](#kernel-53)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-13006    Application(s): kernel](#otp-13006----applications-kernel)
        - [OTP-14310    Application(s): erl_interface, kernel](#otp-14310----applications-erlinterface-kernel)
        - [OTP-14390    Application(s): erts, kernel](#otp-14390----applications-erts-kernel)
        - [OTP-14426    Application(s): kernel](#otp-14426----applications-kernel)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-13805    Application(s): kernel](#otp-13805----applications-kernel)
        - [OTP-13831    Application(s): compiler, erts, hipe, kernel, percept,](#otp-13831----applications-compiler-erts-hipe-kernel-percept)
        - [OTP-13909    Application(s): kernel](#otp-13909----applications-kernel)
        - [OTP-14057    Application(s): kernel](#otp-14057----applications-kernel)
        - [OTP-14059    Application(s): kernel, stdlib](#otp-14059----applications-kernel-stdlib)
        - [OTP-14186    Application(s): erts, kernel](#otp-14186----applications-erts-kernel)
        - [OTP-14357    Application(s): erts, kernel, runtime_tools](#otp-14357----applications-erts-kernel-runtimetools)
        - [OTP-14409    Application(s): kernel](#otp-14409----applications-kernel)
        - [OTP-14417    Application(s): kernel, stdlib](#otp-14417----applications-kernel-stdlib)
        - [OTP-14419    Application(s): kernel](#otp-14419----applications-kernel)
        - [OTP-14425    Application(s): erts, kernel](#otp-14425----applications-erts-kernel)
- [megaco-3.18.2](#megaco-3182)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14387    Application(s): megaco](#otp-14387----applications-megaco)
- [mnesia-4.15](#mnesia-415)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14039    Application(s): mnesia](#otp-14039----applications-mnesia)
- [observer-2.4](#observer-24)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14393    Application(s): observer](#otp-14393----applications-observer)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14137    Application(s): observer](#otp-14137----applications-observer)
        - [OTP-14270    Application(s): observer](#otp-14270----applications-observer)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
        - [OTP-14345    Application(s): observer](#otp-14345----applications-observer)
- [orber-3.8.3](#orber-383)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14006    Application(s): cosProperty, orber](#otp-14006----applications-cosproperty-orber)
- [parsetools-2.1.5](#parsetools-215)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14276    Application(s): parsetools](#otp-14276----applications-parsetools)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
- [public_key-1.4.1](#publickey-141)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14258    Application(s): public_key](#otp-14258----applications-publickey)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14111    Application(s): public_key](#otp-14111----applications-publickey)
        - [OTP-14294    Application(s): public_key](#otp-14294----applications-publickey)
- [reltool-0.7.4](#reltool-074)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14422    Application(s): reltool](#otp-14422----applications-reltool)
- [runtime_tools-1.12](#runtimetools-112)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14316    Application(s): asn1, crypto, runtime_tools](#otp-14316----applications-asn1-crypto-runtimetools)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
...
- [sasl-3.0.4](#sasl-304)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14029    Application(s): sasl](#otp-14029----applications-sasl)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
- [snmp-5.2.6](#snmp-526)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
...
- [ssh-4.5](#ssh-45)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-12872    Application(s): ssh](#otp-12872----applications-ssh)
        - [OTP-14110    Application(s): ssh](#otp-14110----applications-ssh)
        - [OTP-14117    Application(s): ssh](#otp-14117----applications-ssh)
        - [OTP-14193    Application(s): ssh](#otp-14193----applications-ssh)
        - [OTP-14216    Application(s): ssh](#otp-14216----applications-ssh)
        - [OTP-14243    Application(s): ssh](#otp-14243----applications-ssh)
        - [OTP-14259    Application(s): ssh](#otp-14259----applications-ssh)
        - [OTP-14263    Application(s): ssh](#otp-14263----applications-ssh)
        - [OTP-14264    Application(s): ssh](#otp-14264----applications-ssh)
        - [OTP-14267    Application(s): ssh](#otp-14267----applications-ssh)
        - [OTP-14312    Application(s): ssh](#otp-14312----applications-ssh)
        - [OTP-14361    Application(s): ssh](#otp-14361----applications-ssh)
        - [OTP-14362    Application(s): ssh](#otp-14362----applications-ssh)
        - [OTP-14399    Application(s): ssh](#otp-14399----applications-ssh)
        - [OTP-14410    Application(s): ssh](#otp-14410----applications-ssh)
- [ssl-8.2](#ssl-82)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14421    Application(s): ssl](#otp-14421----applications-ssl)
        - [OTP-14443    Application(s): ssl](#otp-14443----applications-ssl)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-13820    Application(s): ssl](#otp-13820----applications-ssl)
        - [OTP-13921    Application(s): crypto, ssl](#otp-13921----applications-crypto-ssl)
        - [OTP-14076    Application(s): ssl](#otp-14076----applications-ssl)
        - [OTP-14077    Application(s): ssl](#otp-14077----applications-ssl)
        - [OTP-14197    Application(s): ssl](#otp-14197----applications-ssl)
        - [OTP-14291    Application(s): ssl](#otp-14291----applications-ssl)
        - [OTP-14382    Application(s): ssl](#otp-14382----applications-ssl)
        - [OTP-14388    Application(s): ssl](#otp-14388----applications-ssl)
- [stdlib-3.4](#stdlib-34)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-13690    Application(s): compiler, stdlib](#otp-13690----applications-compiler-stdlib)
        - [OTP-14295    Application(s): stdlib](#otp-14295----applications-stdlib)
        - [OTP-14296    Application(s): debugger, stdlib](#otp-14296----applications-debugger-stdlib)
        - [OTP-14400    Application(s): common_test, snmp, stdlib](#otp-14400----applications-commontest-snmp-stdlib)
        - [OTP-14454    Application(s): stdlib](#otp-14454----applications-stdlib)
        - [OTP-14531    Application(s): stdlib](#otp-14531----applications-stdlib)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-10289    Application(s): stdlib](#otp-10289----applications-stdlib)
        - [OTP-13692    Application(s): erts, stdlib](#otp-13692----applications-erts-stdlib)
        - [OTP-13801    Application(s): stdlib](#otp-13801----applications-stdlib)
        - [OTP-13830    Application(s): stdlib](#otp-13830----applications-stdlib)
        - [OTP-13831    Application(s): compiler, erts, hipe, kernel, percept,](#otp-13831----applications-compiler-erts-hipe-kernel-percept)
        - [OTP-14000    Application(s): compiler, erts, stdlib](#otp-14000----applications-compiler-erts-stdlib)
        - [OTP-14001    Application(s): stdlib](#otp-14001----applications-stdlib)
        - [OTP-14035    Application(s): stdlib](#otp-14035----applications-stdlib)
        - [OTP-14037    Application(s): stdlib](#otp-14037----applications-stdlib)
        - [OTP-14038    Application(s): stdlib](#otp-14038----applications-stdlib)
        - [OTP-14059    Application(s): kernel, stdlib](#otp-14059----applications-kernel-stdlib)
        - [OTP-14066    Application(s): stdlib](#otp-14066----applications-stdlib)
        - [OTP-14068    Application(s): stdlib](#otp-14068----applications-stdlib)
        - [OTP-14070    Application(s): stdlib](#otp-14070----applications-stdlib)
        - [OTP-14071    Application(s): compiler, stdlib](#otp-14071----applications-compiler-stdlib)
        - [OTP-14089    Application(s): stdlib](#otp-14089----applications-stdlib)
        - [OTP-14094    Application(s): stdlib](#otp-14094----applications-stdlib)
        - [OTP-14102    Application(s): stdlib](#otp-14102----applications-stdlib)
        - [OTP-14123    Application(s): stdlib](#otp-14123----applications-stdlib)
        - [OTP-14168    Application(s): stdlib](#otp-14168----applications-stdlib)
        - [OTP-14183    Application(s): stdlib](#otp-14183----applications-stdlib)
        - [OTP-14190    Application(s): stdlib](#otp-14190----applications-stdlib)
        - [OTP-14226    Application(s): stdlib](#otp-14226----applications-stdlib)
        - [OTP-14245    Application(s): stdlib](#otp-14245----applications-stdlib)
        - [OTP-14278    Application(s): stdlib](#otp-14278----applications-stdlib)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
        - [OTP-14317    Application(s): crypto, stdlib](#otp-14317----applications-crypto-stdlib)
        - [OTP-14319    Application(s): stdlib](#otp-14319----applications-stdlib)
        - [OTP-14323    Application(s): stdlib](#otp-14323----applications-stdlib)
        - [OTP-14328    Application(s): stdlib](#otp-14328----applications-stdlib)
        - [OTP-14331    Application(s): erts, stdlib](#otp-14331----applications-erts-stdlib)
        - [OTP-14347    Application(s): erts, stdlib](#otp-14347----applications-erts-stdlib)
        - [OTP-14369    Application(s): compiler, dialyzer, stdlib](#otp-14369----applications-compiler-dialyzer-stdlib)
        - [OTP-14405    Application(s): stdlib](#otp-14405----applications-stdlib)
        - [OTP-14417    Application(s): kernel, stdlib](#otp-14417----applications-kernel-stdlib)
- [syntax_tools-2.1.2](#syntaxtools-212)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
- [tools-2.10](#tools-210)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14339    Application(s): tools](#otp-14339----applications-tools)
    - [Improvements and New Features](#improvements-and-new-features)
        - [OTP-14253    Application(s): tools](#otp-14253----applications-tools)
        - [OTP-14285    Application(s): common_test, debugger, edoc, observer,](#otp-14285----applications-commontest-debugger-edoc-observer)
- [wx-1.8.1](#wx-181)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14289    Application(s): wx](#otp-14289----applications-wx)
- [xmerl-1.3.15](#xmerl-1315)
    - [Fixed Bugs and Malfunctions](#fixed-bugs-and-malfunctions)
        - [OTP-14377    Application(s): xmerl](#otp-14377----applications-xmerl)
